...
const App = () => {
  return (
    <div>
      ...
      <header className="flex justify-between items-center px-24 py-4"> 
        <div className="flex space-x-8">
          <h1 className='text-[#58679F] text-sm font-normal'>Home</h1>
          <h1 className='text-[#58679F] text-sm font-normal'>About</h1>
          <h1 className='text-[#58679F] text-sm font-normal'>Contact</h1>
        </div>
        <h1 className="text-[#762D2D] text-2xl font-bold">landing</h1>
        <button className='[#65D8DC] text-purple px-8 py-2 rounded-md font-medium'>Buy now</button>
      </header>
      </div>
